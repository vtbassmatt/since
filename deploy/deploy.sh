...
ORPHAN_SCP_CMD="scp -B ${PROJECT_DIR}deploy/lsorphans.sh ${APP_DIR}lsorphans.sh"
ORPHAN_LS_CMD="ssh ${APP_USER}@$APP_HOST '${APP_DIR}lsorphans.sh ${APP_DIR}deploys/ | tee ${APP_DIR}orphans.txt'"
eval $ORPHAN_SCP_CMD
eval $ORPHAN_LS_CMD
